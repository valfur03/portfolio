...
function CppSkill() {
	const projects = [
		<a href="https://github/vfurmane/ft_containers">ft_containers</a>,
	];
	return (
		<>
...
function CSkill() {
	const projects = [
		<a href="https://github/vfurmane/miniRT">miniRT</a>,
		<a href="https://github/vfurmane/fract-ol">fract-ol</a>,
		<a href="https://github/vfurmane/minishell">minishell</a>,
		<a href="https://github/vfurmane/ft_printf">ft_printf</a>,
	];
	return (
		<>
...
function FrontEndSkill() {
	const projects = [
		<a href="https://github/valfur03/portfolio">this portfolio</a>,
		<a href="https://github/theovgl/alekol-42">Alekol</a>,
	];
	return (
		<>
...
function PythonSkill() {
	return (
		<>
			<p>I don't have much knowledge about Python. I don't find this language very interresting (you understood my love for low-level programming by reading the C and C++ sections) and the syntax is quite surprising.</p>
